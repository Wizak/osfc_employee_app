...
export const OrderAdditionalBlock = ({ order }) => (
	<IonGrid className="container">
		<IonRow>
			<IonCol sizeXs='12'>
...
const PhoneOrderPreviewContent = ({ order }) => (
    <Swiper loop={true}>
        <SwiperSlide>
        ...
        <SwiperSlide>
            <OrderAdditionalBlock order={order} />
        </SwiperSlide>
    </Swiper>
);

export default PhoneOrderPreviewContent;